                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <button type="sumbit" class="btn btn-primary btnuser btn-block">Login </button>
                                        <hr>
                                        <a href="index.html" class="btn btn-google btnuser btn-block"><i class="fab fa-google fa-fw"></i> Login with Google</a>
